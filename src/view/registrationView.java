...
public class registrationView extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel2.setPreferredSize(new java.awt.Dimension(600, 415));
        ...
        submit.setBackground(new java.awt.Color(10, 19, 30));
        ...
        clear.setBackground(new java.awt.Color(10, 19, 30));
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    ...
                                    .addComponent(roomNumber, 0, 279, Short.MAX_VALUE)))
                            .addGroup(jPanel2Layout.createSequentialGroup()
    ...
    public void roomNum(){
        ...
        try{
            ...
            if(i==0){
                JOptionPane.showMessageDialog(this, "All room booked");
                set();
            }
        }
        catch(Exception e){
    ...
    public registrationModel getValue(){
        ...
        registrationModel obj=new registrationModel(name, num,email,fName,mName,address,collegeName,roomNum,status);
        return obj;
    }
    ...
    private void submitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitActionPerformed
        // TODO add your handling code here:
        registrationController rcontrol=new registrationController(getValue(),this);
        boolean x=rcontrol.register();
        if(x){
            set();
        }
